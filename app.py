...
def handle_requests():
    """
    Handle /like endpoint requests.
    Region selection:
    - Uses API-detected region (IND, BR, US, ID, BD, TH, VN, SG, MY, PH, EU, RU, ME, PK, CA, MX, AR, CL, TW)
    - If API returns "NA" or fails, defaults to BD server
    - If server_name is provided, it overrides the API-detected region
    """
